...
exports.createResolver = (resFn, errFn) => {
    ...
    const baseResolver = (root, args = {}, context = {}, options = {}) => {
        ...
        return util_1.Promisify(resFn)(root, args, context, options).catch(e => {
    ...
    baseResolver['createResolver'] = (cResFn, cErrFn) => {
        ...
        const childResFn = (root, args, context, options) => {
            ...
            const entry = util_1.isFunction(resFn) ? util_1.Promisify(resFn)(root, args, context, options) : Promise.resolve(null);
            return entry.then(r => {
                ...
                return util_1.isFunction(cResFn) ? util_1.Promisify(cResFn)(root, args, context, options) : Promise.resolve(null);
            });
        };
